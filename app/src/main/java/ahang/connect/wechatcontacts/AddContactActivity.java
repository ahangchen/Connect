...
import ahang.connect.object.UserInfo;
	...
	private void initView() {
        ...
        findViewById(R.id.scan_layout).setOnClickListener(new View.OnClickListener() {
	        ...
	        public void onClick(View v) {
		        ...
		        intent.setClass(mContext, ahang.connect.common.zixng.codescan.MipcaActivityCapture.class);
